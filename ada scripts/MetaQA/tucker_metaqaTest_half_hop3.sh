...
#SBATCH --output=op_file_tucker_metaqa_half_test_hop3.txt
cd M_EmbedKGQA
...
cd KGQA/LSTM
python main.py --mode test --hops 3 --model TuckER --use_cuda True --kg_type half --hidden_dim 256 --relation_dim 200
