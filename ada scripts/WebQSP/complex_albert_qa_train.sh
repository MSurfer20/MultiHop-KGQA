...
#SBATCH --output=complex_albert_webqsp_full_train_op_file.txt
cd M_EmbedKGQA
...
cd KGQA/RoBERTa
python main.py  --mode train --hops webqsp_full --relation_dim 128 --patience 20 --nb_epochs 200 --model ComplEx --use_cuda True --freeze True --outfile best_score_model_complex_albert_full --batch_size 16 --que_embedding_model ALBERT #--load_from best_score_model 
